...
@Service
public class EsQuestionSearchServiceImpl implements EsQuestionSearchService {
...
//            System.out.println(searchResponse.toString());
            ...
            if (hits.getHits() != null && hits.getHits().length > 0) {
                for (SearchHit hit : searchHits) {
                    ...
                    QuestionEsModel questionEsModel = JSONUtil.toBean(hitStr, QuestionEsModel.class);
